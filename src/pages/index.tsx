...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Organic Vegetables`}</title>

        <meta
          name="description"
          content="Experience Online Organic Vegetables, your best choice for a supermarket right at your fingertips. Enjoy affordable prices, discounts, and free same-day home delivery. Quick and easy ordering of organic vegetables online."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1601237321984-be6de0bf3657?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvcmdhbmljJTIwdmVnZXRhYmxlc3xlbnwwfHx8fDE2OTU5Njc1Nzd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@leighskomal?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Leigh Skomal`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Online Organic Vegetables`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Online Organic Vegetables, your best choice for a supermarket right at your fingertips. Enjoy affordable prices, discounts, and free same-day home delivery. Quick and easy ordering of organic vegetables online.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Store Manager" type="store-manager" abilities={appConfig.ownerAbilities} />
