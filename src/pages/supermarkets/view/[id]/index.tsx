...
import { getSupermarketById } from 'apiSdk/supermarkets';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('supermarket', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/supermarkets/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="supermarket" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
