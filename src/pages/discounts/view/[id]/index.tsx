...
import { getDiscountById } from 'apiSdk/discounts';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('discount', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/discounts/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Discount Percentage" text={data?.discount_percentage} />
